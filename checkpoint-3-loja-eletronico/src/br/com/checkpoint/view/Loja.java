...
public class Loja {
	...
	public static void main(String[] args) {
		...
		Endereco endereco = new Endereco("Avenida Lins de Vasconcelos ", 1220, "Aclimação", "São Paulo");
...
//		venda.setCliente(nome);
		...
		case 1: // Departamento video game
			...
			System.out.println("Qual video game você quer comprar? ");
			String compra = leitor.nextLine();
			video.setConsole(leitor.nextLine());
			...
			System.out.println("Preço pago pelo produto: " +"R$"+ produto.getPreco());
		...
		case 2: // Departamento jogos
			...
			System.out.println("Qual jogo você quer comprar? ");
			String compra2 = leitor.nextLine();
			game.setPlataforma(leitor.nextLine());
		...
		case 3:
			...
			computador.setMarca(leitor.nextLine());
			...
			default:
			System.out.println("Departamento não encontrado, tente digitar o numero do departamento correto.");
